...
<div class="teaser">
    <div class="teaser-content p-5 flex flex-col justify-${align} items-${align} <c:if test="${empty alignment}">justify-center items-center</c:if>">
        ...
        <c:if test="${not empty description}">
            <div class="teaser-description my-1">
                <span class="text-md text-grey-700 text-start lg:text-center">${description}</span>
            </div>    
        </c:if>

        <c:if test="${enableCta == 'true'}">
            <div class="cmp-teaser__action-container flex items-start my-3 gap-1 font-sora">
