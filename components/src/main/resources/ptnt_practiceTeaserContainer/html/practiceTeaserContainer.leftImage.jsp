...
<div class="teaser-left-container">
    ...
    <div class="${customCssClass} grid grid-cols-1 lg:grid-cols-${column} justify-center items-center w-full gap-x-4 gap-y-8 ">
        ...
        <c:forEach items="${teasers}" var="teaser" varStatus="item">
            <template:module node="${teaser}" nodeTypes="ptnt:practiceTeaser" editable="true" view="hidden.leftImage" />
        </c:forEach>
    </div>
</div>
    <c:if test="${renderContext.editMode}">
